...
# https://github.com/huggingface/transformers/pull/45471
def model_inference(model, processor, messages, max_new_tokens):
    ...
    content = processor.decode(outputs[0][input_len:], skip_special_tokens=True)
...
def evaluate_test_image(model, processor, model_name, dataset_path, image_path, test_df, pdf_list, save_file_name):
    ...
    for i in tqdm(range(len(test_df))):
        ...
        output = model_inference(model, processor, messages, max_new_tokens=8192)
